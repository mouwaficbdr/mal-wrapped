...
export default function MALWrapped() {
  ...
  const mobileFadeSlideUp = useMemo(() => getFadeSlideUp(isMobile), [isMobile]);
  const mobileStaggerContainer = useMemo(() => getStaggerContainer(isMobile), [isMobile]);
  const mobileStaggerItem = useMemo(() => getStaggerItem(isMobile), [isMobile]);
...
const bottomGradientBackground = 'linear-gradient(to top, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, .4) 25%, rgba(0, 0, 0, 0.3) 60%, rgba(0, 0, 0, .4) 80%, rgba(0, 0, 0, 1) 100%)';
  ...
  function SlideContent({ slide, mangaListData, websiteUrl }) {
    ...
    const ImageCarousel = ({ items, maxItems = 10, showHover = true, showNames = false }) => {
      ...
      // Reduce maxItems on mobile for performance
            ...
            {duplicatedItems.map((item, idx) => {
              ...
              const content = (
                <motion.div 
                  ...
                  transition={isMobile ? {} : { 
                    duration: 0.3,
                    delay: (idx % visibleItems.length) * (isMobile ? 0.02 : 0.05),
                    ease: smoothEase
                  }}
                >
                  <motion.div 
    ...
    switch (slide.id) {
      ...
      case 'anime_count':
        if (stats.thisYearAnime.length === 0) {
          return (
            <SlideLayout bgColor="blue">
              <motion.div className="text-center relative z-10" {...mobileFadeSlideUp} data-framer-motion>
        ...
        return (
          <SlideLayout bgColor="blue">
            <motion.h2 className="body-md font-regular text-white text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>
            {stats.selectedYear === 'all' ? 'Overall' : 'In ' + stats.selectedYear}, you binged through
            </motion.h2>
            <motion.div className="mt-4 text-center relative z-10" {...mobileFadeSlideUp} data-framer-motion>
            ...
            {stats.yearComparison && stats.yearComparison.previousAnimeCount > 0 && (
              <motion.h3 className="body-sm font-regular mt-4 text-white/70 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>
      ...
      case 'anime_time':
        ...
        return (
          <SlideLayout bgColor="green">
            ...
            <motion.div className="mt-4 space-y-6 relative z-10 flex flex-col items-center justify-center" {...mobileFadeSlideUp} data-framer-motion>
          ...
          <SlideLayout  bgColor="yellow">
            ...
            {topGenre ? (
              <>
                ...
                {otherGenres.length > 0 && (
                  <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-1.5 md:gap-2 relative z-10">
                    {otherGenres.map(([genreName, count], idx) => (
                      <motion.div key={idx} className="text-center rounded-xl" style={{ padding: '2px' }} variants={mobileStaggerItem}>
                        <motion.div 
                ...
                <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>You know what you love
            </motion.h3>
              </>
              
            ) : (
              <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>No genres topped your list
            </motion.h3>
            )}
      ...
      case 'drumroll_anime': {
        const DrumrollContent = () => {
          ...
          return (
            <SlideLayout>
            {phase === 0 ? (
              <motion.div className="text-center relative overflow-hidden z-10" {...mobileFadeSlideUp} data-framer-motion>
                <motion.div 
      ...
      case 'top_5_anime': {
        const Top5Content = () => {
          ...
          return (
            <SlideLayout>
              <motion.div className="relative z-10" {...mobileFadeSlideUp} data-framer-motion>
                <motion.h2 className="body-md font-regular text-white text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>
                ...
                <motion.h2 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>A lineup worth bragging about</motion.h2>
              </motion.div>
            </SlideLayout>
          );
        };
          ...
          <SlideLayout bgColor="red">
            ...
            {topStudio ? (
              <>
                ...
                <motion.h3 className="body-sm font-regular text-white/70 text-center text-container mt-4 relative z-10" {...mobileFadeSlideUp} data-framer-motion>
                You know who gets the job done
            </motion.h3>
              </>
            ) : (
              <motion.h3 className="body-md font-regular text-white/70 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>
      ...
      case 'seasonal_highlights':
        ...
        if (!hasAnySeasonalData) {
          return (
            <SlideLayout bgColor="pink">
              <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>
        ...
        return (
          <SlideLayout bgColor="pink">
            ...
            <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>You caught every wave right on time
            </motion.h3>
          </SlideLayout>
        );
      ...
      case 'hidden_gems_anime':
        ...
        return (
          <SlideLayout bgColor="blue">
            ...
            <motion.div className="mt-4 relative z-10" {...mobileFadeSlideUp} data-framer-motion>
          ...
          <SlideLayout  bgColor="red">
            ...
            {didntLand.length > 0 ? (
              <motion.div className="relative z-10" {...mobileFadeSlideUp} data-framer-motion>
                ...
                <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>Not everything hit the way you hoped
            </motion.h3>
              </motion.div>
            ) : (
              <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>Nothing rated low, because nothing was rated at all</motion.h3>
            )}
          ...
          <SlideLayout  bgColor="green">
            ...
            {plannedAnimeItems.length > 0 ? (
              <motion.div className="relative z-10" {...mobileFadeSlideUp} data-framer-motion>
                ...
                <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>One day you’ll get to them… probably</motion.h3>
              </motion.div>
            ) : (
              <motion.h3 className="body-sm font-regular text-white/70 mt-4 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>You didn’t add anything to your plan-to-watch list</motion.h3>
            )}
          </SlideLayout>
        );
                ...
                {otherMangaGenres.length > 0 && (
                  ...
                  <motion.div key={idx} className="text-center rounded-xl" style={{ padding: '2px' }} variants={mobileStaggerItem}>
                      ...
                      className="bg-black/70 rounded-xl p-2 h-full"
                        ...
                        >
                          <p className="heading-sm font-semibold text-white truncate"><span className="body-xs font-regular text-white/70">{idx + 2}.</span> {genreName}</p>
                          <p className="body-xs text-white/70 font-regular">{count} manga</p>
                      </motion.div>
                      </motion.div>
                    ))}
                  </div>
                )}
                <motion.h3 className="body-sm font-regular text-white/70 text-center text-container relative z-10 mt-4" {...mobileFadeSlideUp} data-framer-motion>
                    ...
                    {otherAuthors.map(([authorName, count], idx) => (
                      <motion.div key={idx} className="text-center rounded-xl" style={{ padding: '2px' }} variants={mobileStaggerItem}>
                        ...
                        >
                          ...
                          <p className="body-xs text-white/70 font-regular">{count} titles</p>
                      </motion.div>
                      </motion.div>
        ...
        return (
          ...
          These manga weren't to your taste
            ...
            {mangaDidntLand.length > 0 ? (
              <motion.div {...mobileFadeSlideUp} data-framer-motion>
      ...
      case 'milestones':
        ...
        return (
          <SlideLayout bgColor="yellow">
            ...
            <motion.h3 className="body-sm font-regular text-white/70 mt-6 text-center text-container relative z-10" {...mobileFadeSlideUp} data-framer-motion>
      ...
      case 'badges':
        ...
        return (
          <SlideLayout bgColor="purple">
            ...
            <motion.div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-1.5 md:gap-2 max-w-3xl mx-auto relative z-10" {...mobileFadeSlideUp} data-framer-motion>
      ...
      case 'character_twin':
        ...
        return (
          <SlideLayout bgColor="pink">
            ...
            <motion.div className="mt-6 flex flex-col items-center relative z-10" {...mobileFadeSlideUp} data-framer-motion>
