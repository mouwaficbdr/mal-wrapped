      ...
      <SlideLayout verticalText={verticalText}>
        {phase === 0 ? (
          ...
          <div className="animate-fade-slide-up">
            ...
            <div className="mt-2 grid grid-cols-1 gap-2 sm:gap-3 w-full" style={{ gridTemplateRows: '1fr 1fr', height: 'fit-content' }}>
              {(() => {
                const [featured, ...others] = top5Formatted;
                return (
                  <>
                    <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden group transition-all duration-300 hover:border-[#9EFF00]/50 flex flex-row relative w-full min-h-0">
                    ...
                    {others.length > 0 && (
                      <div className="grid grid-cols-4 gap-1.5 sm:gap-2 w-full min-h-0">
                        {others.map((item, index) => {
                          ...
                          const itemContent = (
                            <div className="flex flex-col w-full min-w-0 h-full">
                              <div className="bg-transparent border border-white/10 rounded-lg overflow-hidden group aspect-[2/3] relative transition-all duration-300 hover:border-[#9EFF00] hover:border-2 w-full flex-1" style={{ boxSizing: 'border-box' }}>
